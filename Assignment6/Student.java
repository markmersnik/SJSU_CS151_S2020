		...
		if(attribute.equalsIgnoreCase("name")) {
			...
			Collections.sort(courses, new Comparator<Course>() {
				  ...
				  public int compare(Course c1, Course c2) {
					  Integer c1Day = 0;
					  Integer c2Day = 0;
					  switch(c1.getDayOfTheWeek().substring(0, 2).toLowerCase()) {
					  	case "mo": c1Day = 1; break;
					  	case "tu": c1Day = 2; break;
					  	case "we": c1Day = 3; break;
					  	case "th": c1Day = 4; break;
					  	case "fr": c1Day = 5; break;
					  }
					  switch(c2.getDayOfTheWeek().substring(0, 2).toLowerCase()) {
					  	case "mo": c2Day = 1; break;
					  	case "tu": c2Day = 2; break;
					  	case "we": c2Day = 3; break;
					  	case "th": c2Day = 4; break;
					  	case "fr": c2Day = 5; break;
					  }
					  return c1Day.compareTo(c2Day);
				  }
				});
			if(!ascending) {
				Collections.reverse(courses);
